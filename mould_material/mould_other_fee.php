    ...
    <table>
      <tr>
        ...
        <td>
            ...
            <input type="button" name="button" value="导出" class="button" onclick="location.href='excel_mould_material_list.php'" />
  ...
  <form action="mould_materialdo.php" name="mould_material_list" method="post">
    <table>
      ...
      <tr>
        ...
        <td><?php if(!in_array($materialid,$array_order)){ ?><a href="mould_materialae.php?id=<?php echo $materialid; ?>&action=edit"><img src="../images/system_ico/edit_10_10.png" width="10" height="10" /></a><?php } ?></td>
      </tr>
      <?php } ?>
    </table>
    <div id="checkall">
