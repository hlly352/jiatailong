...
$objActSheet->setCellValue('G1', '订单数量');
$objActSheet->setCellValue('H1', '单位');
$objActSheet->setCellValue('I1', '实际数量');
$objActSheet->setCellValue('J1', '单位');
$objActSheet->setCellValue('K1', '供应商');
$objActSheet->setCellValue('L1', '入库日期');
...
if($result->num_rows){
	...
	while($row = $result->fetch_assoc()){
		...
		$objActSheet->setCellValue('K'.$i, $row['supplier_cname']);
		$objActSheet->setCellValue('L'.$i, $row['dodate']);
		$objActSheet->setCellValue('M'.$i, $row['remark']);
		$i++;
	}
