  ...
  <form action="" name="search" method="get">
    <table>
      <tr>
        ...
        <input type="button" name="button" value="添加" class="button" onclick="location.href='cutter_outdown_list_add.php?entryid=<?php echo $entryid; ?>'" />
        <input type="button" name="button" value="打印" class="button" onclick="window.open('cutter_outdown_print.php?id=<?php echo $entryid; ?>')" />
