...
$(function(){
	...
	$("#quantity").blur(function(){
		...
		if(!rf_b.test(quantity)){
			...
			$("#inout_quantity").val(parseFloat(quantity).toFixed(2));
...
<div id="table_sheet">
  ...
  <form action="material_out_list_outdo.php" name="material_out_list_out" method="post">
    <table>
      ...
      <tr>
        <th>出库数量：</th>
        <td><input type="text" name="quantity" id="quantity" value="<?php echo $array['order_surplus']; ?>" class="input_txt" />
