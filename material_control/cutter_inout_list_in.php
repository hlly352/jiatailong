...
<div id="table_list">
  ...
  <table>
    ...
    <tr>
      ...
      <td><?php if($employeeid == $row['employeeid']){ ?><a href="cutter_in_list_in.php?id=<?php echo $inoutid; ?>&action=edit"><img src="../images/system_ico/edit_10_10.png" width="10" height="10" /></a><?php } ?></td>
