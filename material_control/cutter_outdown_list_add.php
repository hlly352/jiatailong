...
$sql_entry = "SELECT `db_outdown`.`entry_number`,`db_outdown`.`entry_date`,`db_outdown`.`dotime`,`db_employee`.`employee_name` FROM `db_outdown` INNER JOIN `db_employee` ON `db_employee`.`employeeid` = `db_outdown`.`employeeid` WHERE `db_outdown`.`entryid` = '$entryid' AND `db_outdown`.`dotype` = 'C' AND `db_outdown`.`employeeid` = '$employeeid'";
    ...
    <table>
      <tr>
        ...
        <td><input type="submit" name="submit" value="查询" class="button" />
          <input type="button" name="button" value="明细" class="button" onclick="location.href='cutter_godown_entry_list.php?entryid=<?php echo $entryid; ?>'" />
...
<div id="table_list">
  <form action="cutter_outdown_list_adddo.php" name="cutter_godown_entry_list_add" method="post">
