  ...
  <form action="" name="search" method="get">
    <table>
      <tr>
        ...
        <input type="button" name="button" value="明细" class="button" onclick="location.href='other_material_outdown_list.php?entryid=<?php echo $entryid; ?>'" />
...
?>
<div id="table_list">
  <form action="other_outdown_list_adddo.php" name="material_godown_entry_list_add" method="post">
