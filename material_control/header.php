...
<div id="menu">
  <ul>
    ...
    <li class="menulevel"><a href="in_list.php">入库操作</a>
    <!--   <ul>
    ...
    <!--<li class="menulevel"><a href="godown_entry.php">入库处理</a>
       <ul>
    ...
    <li class="menulevel"><a href="out_list.php">出库操作</a>
      <!-- <ul>
    ...
    <li class="menulevel"><a href="inout_list_out.php">出库记录</a>
      <!-- <ul>
    ...
    <li class="menulevel"><a href="#">库存</a></li>
    <li class="menulevel"><a href="abnormal_in.php">异常入库</a>
      <!-- <ul>
