  ...
  <form action="moulddo.php" name="mould_list" method="post">
    ...
    ?>
      <tr>
        ...
        <td>
          <?php echo shows($row,'processing_technology') ?>
        </td>
        <td>
          <?php echo shows($row,'processing_plan'); ?>
        </td>
        <td>
          <?php echo shows($row,'check_report'); ?>
        </td>
        <td>
          <?php echo shows($row,'maching_red_photo'); ?>
        </td>
        <td>
          <?php echo shows($row,'installation_report'); ?>
        </td>
        <td><a href="<?php echo 'processing_data_edit.php?action=add&specification_id='.$row['mould_specification_id'].'&mouldid='.$row['mould_dataid']; ?>">更新</a></td>
      </tr>
      <?php } ?>
    </table>
   <!--  <div id="checkall">
