    ...
    <table>
      ...
      <tr>
        ...
        <td width="20%">
          ...
          &nbsp;&nbsp;
          <?php if($isadmin == 1){ ?>
          <a href="processing_data_do.php?action=del&informationid=<?php echo $_GET['informationid'] ?>&key=<?php echo $k ?>&data=<?php echo $_GET['data'] ?>" onclick="javascript:return confirm('确认删除?');">删除</a>
        <?php }?>
        </td>
      </tr>
     ...
     <?php } }?>
      <tr>
        ...
        <td colspan="8" style="text-align:center">
          <input type="button" name="" class="button" value="添加" id="add" onclick="javascript:window.location.href='processing_data_edit.php?action=add&specification_id=<?php echo $specificationid ?>'">
