...
<div id="table_search">
  <h4>外协费用月报表</h4>
  <form action="" name="report_mould_outward_month" method="get">
    <table>
      <tr>
        <th>年份：</th>
        ...
        <td><input type="submit" name="submit" value="查询" class="button" />
          <input type="button" name="button" value="图示" class="button" onclick="window.open('jpgraph_report_mould_outward_month.php?year=<?php echo $year; ?>')" /></td>
      </tr>
    </table>
  </form>
</div>
