  ...
  <form action="order_taskdo.php?action=add" name="list" method="post">
    ...
    ?>
      <tr>
        ...
        <th rowspan="3">零件图片</th>
        <th rowspan="3">合同金额</th>
        <th rowspan="3">币别</th>
        <th rowspan="3">汇率</th>
        <th rowspan="3">未税金额</th>
        <th rowspan="3">订单人民币金额</th>
        <th rowspan="3">税金</th>
        <th rowspan="3">价税合计</th>
        <th rowspan="3">收款进度</th>
        <th rowspan="3">发票进度</th>
        <th rowspan="3">付款进度</th>
        <th rowspan="3">完工比</th>
        <th rowspan="3">材料成本</th>
        <th rowspan="3">制造费用</th>
        <th rowspan="3">盈亏</th>
        <th rowspan="3">盈亏比</th>
        <th colspan="4">一期</th>
        <th colspan="4">二期</th>
     ...
     <tr class="show">
        ...
        <td class="show_list"><?php echo $row['notes']?></td>
        <td class="show_list"><?php echo $row['notes']?></td>
        <td class="show_list"><?php echo $row['mould_dataid']?></td>
        ...
        <td class="show_list"><?php echo $paylist['four_reality_amount']?></td>
         <td class="show_list"><?php echo $paylist['five_plan_date']?></td>
        <td class="show_list"><?php echo $paylist['five_plan_amount']?></td>
        <td class="show_list"><?php echo $paylist['five_reality_date']?></td>
        <td class="show_list"><?php echo $paylist['five_reality_amount']?></td>
      </tr> 
