    ...
    <table>
      <tr>
        ...
        <td><input type="submit" name="submit" value="查询" class="button" />
          <input type="button" name="button" value="导出" class="button"  /></td>
      </tr>
    </table>
  </form>-->
</div> 
<div id="table_list">
  ...
  <form action="material_inquiry_listdo.php" name="material_inquiry_list" method="post">
    <table>
      ...
      if(array_key_exists($inquiry_orderid,$array_count)){
	  ?>
      <tr>
        <td><input type="checkbox" name="id[]" value="<?php echo $inquiry_orderid; ?>" checked="checked" /></td>
        <td><?php echo $row['inquiry_number']; ?></td>  
        <td><?php echo $row['inquiry_date']; ?></td>
        <td><?php echo $row['employee_name']; ?></td>
        <td><?php echo $array_count[$row['inquiry_orderid']]; ?></td>
        <td>
          <a href="excel_material_inquiry.php?id=<?php echo $inquiry_orderid ?>">
            <img src="../images/system_ico/excel_10_10.png">
          </a>
        </td>
        <td>
