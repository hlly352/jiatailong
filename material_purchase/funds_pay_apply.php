...
<?php
  ...
  <?php
    ...
    <tr>
          ...
          <td class="count count_<?php echo $row_list['supplierid'] ?>">
            <?php echo $total[$row_list['supplierid']]['total'] ?>
          </td>
          <td>
            <a href="funds_plan_list_print.php?id=<?php echo $row_list['listid']; ?>" target="_blank"><img src="../images/system_ico/print_10_10.png" width="10" height="10" /></a>
          </td>
          <?php 
          ?>
      </tr> 
