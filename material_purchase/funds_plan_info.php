    ...
    ?>
      ...
      <tr>
        ...
        <?php 
          ...
          <?php } elseif($action == 'approval_edit'){ ?>
          <input type="button" name="" class="button" value="通过" onclick="location.href='funds_plan_approval_do.php?action=approval_edit&planid=<?php echo $planid ?>'" >
          <?php } ?>
