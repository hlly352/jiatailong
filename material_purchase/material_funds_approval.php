...
<div id="table_list">
  ...
  <form action="material_balance_account_do.php" method="post">
    <tr>
      ...
      <td><a href="material_funds_manage_do.php?action=edit&id=<?php echo $row['fundsid']; ?>">批准</a></td>
    </tr>
    <?php 
    	$amount += $row['amount'];
