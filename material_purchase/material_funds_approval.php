...
<div id="table_list">
  ...
  <form action="material_balance_account_do.php" method="post">
    <tr>
      ...
      <td><a href="material_funds_manage_do.php?action=approval&id=<?php echo $row['accountid']; ?>">批准</a></td>
    </tr>
    <?php 
    	$amount += $row['amount'];
    } ?>
