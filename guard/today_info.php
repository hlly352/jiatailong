...
<div id="goout">
  ...
  <dl>
    ...
    <dt><input type="button" name="button" value="<?php echo $goout_dotype; ?>" class="button" onclick="location.href='employee_goout_confirm.php?id=<?php echo $gooutid; ?>'"<?php if($confirmer_in && $confirmer_out) echo " disabled=\"disabled\""; ?> /></dt>
  </dl>
  <?php } ?>
  <div class="clear"></div>
  <?php
...
<div id="goout">
  ...
  <dl>
    ...
    <dt><input type="button" name="button" value="<?php echo $leave_dotype; ?>" class="button" onclick="location.href='employee_leave_confirm.php?id=<?php echo $leaveid; ?>'"<?php if($confirmer_in && $confirmer_out) echo " disabled=\"disabled\""; ?> /></dt>
  </dl>
  <?php } ?>
  <div class="clear"></div>
  <?php
...
<div id="express">
  ...
  if($result_express->num_rows){
	  while($row_express = $result_express->fetch_assoc()){
		  $reckoner = $row_express['reckoner'];
		  $issettle = $reckoner?'已结算':'未结算';
  ?>
  <dl>
    ...
    <input type="button" name="button" value="<?php echo $issettle; ?>" class="button" onclick="location.href='employee_express_settle.php?id=<?php echo $row_express['expressid']; ?>'"<?php if($reckoner) echo " disabled=\"disabled\""; ?> />
  </dl>
  <?php } ?>
  <div class="clear"></div>
  <?php
...
<div id="express">
  ...
  <dl>
    ...
    <dt><input type="button" name="button" value="<?php echo $array_express_get_status[$get_status]; ?>" class="button" onclick="location.href='employee_express_receive_confirm.php?id=<?php echo $express_receiveid; ?>'"<?php if(!$apply_status || $get_status) echo " disabled=\"disabled\""; ?> /></dt>
  </dl>
  <?php } ?>
  <div class="clear"></div>
  <?php
