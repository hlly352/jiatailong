...
$objActSheet->setCellValue('H1', '类型');
$objActSheet->setCellValue('I1', '班次');
$objActSheet->setCellValue('J1', '状态');
$objActSheet->setCellValue('K1', '出厂确认人');
$objActSheet->setCellValue('L1', '回厂确认人');
...
if($result->num_rows){
	...
	while($row = $result->fetch_assoc()){
		...
		$objActSheet->setCellValue('G'.$i, $row['leavetime']);
		$objActSheet->setCellValue('H'.$i, $row['vacation_name']);
		$objActSheet->setCellValue('I'.$i, $array_work_shift[$row['work_shift']]);
		$objActSheet->setCellValue('J'.$i, $array_status[$row['leave_status']]);
		$objActSheet->setCellValue('K'.$i, $confirmer_outname);
		$objActSheet->setCellValue('L'.$i, $confirmer_inname);
		$i++;
	}
...
//设置字体   
$objStyle1 = $objActSheet->getStyle('A2:L'.($i-1)); 
