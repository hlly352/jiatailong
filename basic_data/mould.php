    ...
    <table>
      <tr>
        ...
        <td><input type="submit" name="submit" value="查询" class="button" />
          <input type="button" name="button" value="添加" class="button" onclick="location.href='mouldae.php?action=add'" />
  ...
  <form action="moulddo.php" name="mould_list" method="post">
    <table>
      ...
      <tr>
        ...
        <td><a href="mouldae.php?id=<?php echo $mouldid; ?>&action=edit"><?php echo $row['mould_number']; ?></a></td>
