...
//项目资料类型
$array_project_data_type = array(array('技术资料',array('project_data'=>'客户项目资料','mould_data'=>'客户模具资料','drawing'=>'客户2D图纸')),array('项目启动会',array('project_review'=>'评审记录','dfm_report'=>'DFM报告','progress'=>'进度规划','customer_confirm'=>'客户确认')),array('模具试模',array('red_photo'=>'机上红丹照片','sample_photo'=>'走水板、样品照片','trial_mode'=>'试模报告')),array('模具交付及售后',array('after_sale_confirm'=>'客户确认','out_factory'=>'出厂检查表','car_photo'=>'装箱、装车照片','delivery_note'=>'放行单、送货单','service'=>'售后服务表','customer_indication'=>'客户交付指示')),array('项目总结',array('project_sum'=>'总结报告')));
//改模资料
$array_mould_modify = array('last_report'=>'上次试模报告','modify_data'=>'内部改模资料','modity_plan'=>'改模计划','drawing_connection'=>'图纸联络单','before_check'=>'装模前检查表','try_apply'=>'试模申请','dan_photo'=>'机上红丹照片','sample_photo'=>'样品照片','try_report'=>'试模报告','sample_check'=>'样品检测报告','sample_delivery'=>'样品交付');
?>