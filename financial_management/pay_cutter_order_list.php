...
<div id="table_sheet">
  ...
  <table>
    ...
    <tr>
      ...
      <th>备注：</th>
      <td colspan="3"><?php echo $array['reamrk']; ?></td>
    </tr>
  </table>
</div>
<div id="table_sheet">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="submit" name="submit" id="submit" value="确定" class="button" />
          ...
          <input type="hidden" name="data_type" id="data_type" value="MC" />
