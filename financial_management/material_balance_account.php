...
<div id="table_list">
  ...
  <form action="material_balance_account_do.php" method="post">
    <tr>
      ...
      <td><a href="material_account_info.php?id=<?php echo $row['accountid']; ?>"><img src="../images/system_ico/info_8_10.png" width="8" height="10" /></a></td>
      <td>
        <a href="material_balance_account_do.php?id=<?php echo $inoutid ?>">审核</a>
      </td>
    </tr>
    <?php 
    	$amount += $row['amount'];
