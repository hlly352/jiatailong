...
<?php include "header.php"; ?>
  ...
  <dl>
    <dt> 财务管理操作流程：</dt>
    <dd class="tag">  采购管理>>2019-09-06</dd>
    <dd class="content">1、对账审核：对采购人员对账完成的信息进行审核。</dd>
    <dd class="content">2、发票接收：查看并接收采购人员录入的发票信息。</dd>
    <dd class="content">3、付款审核：财务人员审核采购安排的付款计划和付款事项，出纳对已通过审核的付款事项进行了付款操作，会计对出纳的付款操作进行复核。</dd>
    <dd class="content">4、账款管理：查看所有供应商的付款信息。</dd>
    <dd class="content">4、模具成本：每套模具的成本信息。</dd>
  </dl>
</div>
<?php
