...
<html lang="zh-CN">
    <head>
        <meta charset="utf-8">
        <link rel="alternate" title="VEIDC测评" href="https://www.veidc.com/" type="application/rss+xml" />
	    <link rel="stylesheet" href="./css/favicon.css" type="text/css" />
	    <title>ICO图标在线转换工具——VEIDC测评</title>
    ...
    <body>
	<div id="favicon-area">
	    <a style="display: block; text-indent: 0em;" href="https://www.veidc.com/"><img src="./img/Advertising.png" alt="" width="800" />
		</a>
        <h1>ICO图标在线转换</h1>
	...
	<div id="favicon-area-copyright">
        &copy;2019 | <a href="https://www.veidc.com/">VEIDC测评</a>
    </div>
